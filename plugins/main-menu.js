...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    let after = conn.menu.after || (conn.user.jid == global.conn.user.jid ? '' : `Powered by https://wa.me/6285797375014${global.conn.user.jid.split`@`[0]}`) + defaultMenu.after
    let _text = [
      before,
